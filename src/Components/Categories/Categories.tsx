...
const Categories = () => {
  return (
    <section className=' min-h-screen flex items-center justify-center flex-col'>
      <h2 className='flex-1 flex items-end' >Compras por categorias</h2>
      <div className='flex-2 basis-5/6 grid grid-cols-1 sm:grid-cols-2 lg:flex lg:items-stretch lg:justify-center gap-2 p-16'>
